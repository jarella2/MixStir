                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Experience the rich tapestry of global cuisine with MixStir. From spicy Indian curries to delicate Japanese sushi, embark on a journey of culinary discovery unlike any other',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'MixStir isn\'t just about cooking—it\'s about connecting. Share your culinary creations, swap recipes, and bond with fellow food enthusiasts from every corner of the globe.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              ' Explore the world\'s flavors and cultures without leaving your kitchen. With MixStir, every meal becomes an opportunity for cultural exchange and celebration. Join us in breaking bread—and barriers—one recipe at a time.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
