...
import 'schema/markets_record.dart';
...
export 'schema/markets_record.dart';
...
/// Functions to query MarketsRecords (as a Stream and as a Future).
Future<int> queryMarketsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MarketsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MarketsRecord>> queryMarketsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MarketsRecord.collection,
      MarketsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MarketsRecord>> queryMarketsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
