        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'pubprofile',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'pubprofile')
                  : const PubprofileWidget(),
            ),
            FFRoute(
              name: 'privprofile',
              path: 'privprofile',
              builder: (context, params) => const PrivprofileWidget(),
            ),
            FFRoute(
              name: 'community',
              path: 'community',
            ...
            FFRoute(
              name: 'Recipe',
              path: 'recipe',
              builder: (context, params) => const RecipeWidget(),
            ),
            FFRoute(
              name: 'Recipe2',
              path: 'recipe2',
              builder: (context, params) => const Recipe2Widget(),
            ),
            FFRoute(
              name: 'Recipe2Copy',
              path: 'recipe2Copy',
              builder: (context, params) => const Recipe2CopyWidget(),
            ),
            FFRoute(
              name: 'RecipeFinal',
              path: 'recipeFinal',
              builder: (context, params) => const RecipeFinalWidget(),
            ),
            FFRoute(
              name: 'RecipeFinalCopy',
              path: 'recipeFinalCopy',
              builder: (context, params) => const RecipeFinalCopyWidget(),
            )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/MixStir_logo.png',
